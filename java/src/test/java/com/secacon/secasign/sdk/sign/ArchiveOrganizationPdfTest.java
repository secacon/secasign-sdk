...
public class ArchiveOrganizationPdfTest {
    ...
    public void testArchiveOrganizationPdfDocumentWithVisualSignature(SdkConfiguration sdkConfiguration) throws Exception {
        ...
        // Flag whether to embed LTV information such as CRLs and OCSPs into the signed PDF document. This is normally desired, except in a few rare cases like handing in eBills at SIX
